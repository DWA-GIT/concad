...
public class RankingCalculatorViewer implements RankingViewer{
	...
	public void createTableViewer(RankingViewerComparator comparator, TableViewer viewer){
		TableViewerColumn colKindOfSmell = createTableViewerColumn(comparator, viewer, "Code smell", 120, 0);
	...
	protected SelectionAdapter getSelectionAdapter(final RankingViewerComparator comparator, 
			final TableViewer viewer,final TableColumn column,
		      final int index) {
